  ...
  return (
    <div className="flex h-screen" style={{ backgroundColor: '#F4F8FA' }}>
        ...
        <div className="flex-1 flex flex-col">
            ...
            />
            <button onClick={AdminUserCreate} className="inline-flex justify-center items-center space-x-2 border border-gray-300 px-3.5 rounded-md" style={{ backgroundColor: '#006F68' , whiteSpace: 'nowrap'}}>
