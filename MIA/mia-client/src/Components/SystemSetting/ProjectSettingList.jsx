...
const ProjectSettingList = () => {
  ...
  const ProjectSettingCreate = () => {
    navigate(`/projectsetting/create`); 
  }
        ...
        <div className="px-6 ">
          <div className="flex w-full rounded-md my-4 gap-3">
            ...
            <button className="flex justify-center items-center space-x-2 border border-gray-300 px-3.5 rounded-md" style={{ backgroundColor: '#006F68' }}>
              ...
              <div onClick={ProjectSettingCreate} className="ml-2 " style={{color:'white'}}>สร้าง</div> 
            </button>
            </div>
...
export default ProjectSettingList;
