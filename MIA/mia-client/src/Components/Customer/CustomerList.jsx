        ...
        <div className="p-6">
          <div className="p-6 bg-white">
            <div className="flex w-full rounded-md mb-4 gap-3">
              ...
              />
              <button onClick={CustomerCreate} className="inline-flex justify-center items-center space-x-2 border border-gray-300 px-3.5 rounded-md" style={{ backgroundColor: '#006F68' , whiteSpace: 'nowrap'}}>
